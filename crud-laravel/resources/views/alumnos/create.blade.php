...
<main>
    <div class="container py-4">
        ...
        <form action="{{ url('alumnos') }}" method="post">
            ...
            <div class="mb-3 row">
                <label for="matricula" class="col-sm-2 col-form-label">Nombre Completo:</label>
                <div class="col-sm-5">
            ...
            <div class="mb-3 row">
                <label for="matricula" class="col-sm-2 col-form-label">Fecha de nacimiento:</label>
                <div class="col-sm-5">
            ...
            <div class="mb-3 row">
                <label for="matricula" class="col-sm-2 col-form-label">Telefono</label>
                <div class="col-sm-5">
            ...
            <div class="mb-3 row">
                <label for="matricula" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-5">
